...
/* Includes ------------------------------------------------------------------*/
#include "main.h"
#include "../../Device Drivers/Matrix Keypad/Matrix_Keypad.h"
...
/* USER CODE BEGIN PV */
Matrix_Keypad_t kp = { .Rows = 4, .Columns = 4, .InputPort = GPIOB,
		.OutputPort = GPIOA, .InputStartingPin = 12, .OutputStartingPin = 4 };
/* USER CODE END PV */
